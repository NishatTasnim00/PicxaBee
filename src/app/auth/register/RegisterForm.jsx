  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 ">
      ...
      <button
        ...
        type="submit"
        className="bg-primary-color border border-primary-color hover:text-primary-color duration-300 hover:bg-transparent w-full text-white rounded-md p-3 mt-3"
      >
        Submit
      </button>
    </form>
