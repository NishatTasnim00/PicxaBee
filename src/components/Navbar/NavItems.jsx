...
import picxabee from "../../../public/swarm.png";
          ...
          <div className="flex items-center gap-2">
            ...
            <li>
              <a className=" hover:bg-transparent ">
                <Image
                  alt="User image"
                  src={loggedInUser?.profile_picture || picxabee}
                  width={35}
                  height={35}
                  className="h-8 w-8 rounded-full  hover:scale-125 border-2 dark:border-gray border-primary-color transform transition-transform"
                  onClick={toggleDrawer}
            ...
            <div className="hover:scale-110  transform transition-transform">
              {" "}
              <Link
                className="  text-primary-color dark:hover:text-primary-color hover:text-white hover:bg-primary-color dark:hover:bg-black bg-white  py-2 border-primary-color border dark:bg-primary-color dark:text-white shadow-primary-color font-semibold px-2 rounded-xl ml-5"
                href="/auth/signin"
              >
                Sign In
              </Link>
